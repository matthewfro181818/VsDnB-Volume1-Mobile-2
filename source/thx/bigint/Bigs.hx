...
inline public static var BASE:Int = 10000000; // 1e7;
	...
	public static var MAX_INT(default, null):Int = #if js.Syntax.code("9007199254740992") #else 2147483647 #;
...
var x = #if js.Syntax.code("new Array")(length) #else [] #;
		for (i in 0...length)
			x[i] = 0;
		return x;
}
...
// assumes a and b are arrays with a.length >= b.length;
		var l_a = a.length,;
			l_b = b.length,;
			r = #if js.Syntax.code("new Array")(l_a) #else [] ,;
			carry = 0,;
			sum,
			i = 0;
		while (i < l_b) {
...
// assumes a is array, carry is number with 0 <= carry < MAX_INT;
		var l = a.length,;
			r = #if js.Syntax.code("new Array")(l) #else [] ,;
			sum,
			i = 0;
		while (i < l) {
sum = a[i] - BASE + carry;
...
// assumes a and b are arrays with a >= b;
		var a_l = a.length,;
			b_l = b.length,;
			r = #if js.Syntax.code("new Array")(a_l) #else [] ,;
			borrow = 0,;
			i = 0,;
			difference;
		while (i < b_l) {
...
// assumes a is array, b is number with |b| < BASE
		var l = a.length,;
			r:Array<Float> = #if js.Syntax.code("new Array")(l) #else [] ,;
			carry:Float = 0.0,;
			product:Float,
			i = 0,;
			a_i:Float,
...
a_j = a[j]#if (neko || eval) + 0.0 # # # # # #end;
	...
	public static function divMod1(a:Array<Int>,
			b:Array<Int>):Array<{small:Null<Int>, big:Array<Int>}> {
...
quotientDigit = BASE - 1.0;
			quotientDigit = Math.ffloor(((remainder[shift + b_l]#if (neko || eval) + 0.0000000001 #) * BASE # # # # #end;
