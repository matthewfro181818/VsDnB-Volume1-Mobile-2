...
class FlxAnimationController {
	...
	public function destroyAnimations():Void {
		// Flixel 5.3 stores animations in _animations (private),
		// so we can only safely reset the public list.
		animations = [];
	}
	 ...
	 */
	public function addByPrefix(name:String, prefix:String, frameRate:Float = 24, loop:Bool = false, flipX:Bool = false, flipY:Bool = false) {
		...
		var anim = new FlxAnimation(this, name, ids, frameRate, loop, flipX, flipY);
	 ...
	 */
	public function addByIndices(name:String, prefix:String, indices:Array<Int>, frameRate:Float = 24, loop:Bool = false, flipX:Bool = false,
			flipY:Bool = false) {
		...
		var anim = new FlxAnimation(this, name, selected, frameRate, loop, flipX, flipY);
