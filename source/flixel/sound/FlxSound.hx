...
class FlxSound extends FlxBasic {
	...
	// Psych Engine compatibility – Flixel 5 removed x/y fields
	...
	function updateTransform():Void {
		_transform.volume = (FlxG.sound.muted ? 0 : 1) * FlxG.sound.volume * (group != null ? group.volume : 1) * _volume * _volumeAdjust;
	...
	public inline function get_playing():Bool
