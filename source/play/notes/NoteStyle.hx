...
case 'pixel':
			...
			default:
				sprite.animation.addByPrefix('purpleholdend', 'pruple hold');
				sprite.animation.addByPrefix('blueholdend', 'blue hold ');
				sprite.animation.addByPrefix('greenholdend', 'green hold ');
				sprite.animation.addByPrefix('redholdend', 'red hold ');
...
case 'pixel':
			...
			case '3d':
				...
				sprite.animation.addByPrefix('loop', 'loop', 24);
				sprite.animation.addByPrefix('', '', 24, false);
			default:
				...
				sprite.animation.addByPrefix('', 'sustain cover pre0', 24, false);
}
}
