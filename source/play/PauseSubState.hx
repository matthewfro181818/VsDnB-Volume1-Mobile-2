...
/**
	...
	[ {name: 'Resume', callback: closeMenu, {name: 'Restart Song', callback: restartSong,
#if debug {name: 'No Miss Mode', callback: toggleNoMiss,
		#{name: 'Options', callback: openSettingsMenu}, {name: 'Exit to menu', callback: returnBackToMenu}
	];
	...
	[ {name: 'Resume', callback: closeMenu}, {name: 'Skip Dialogue', callback: finishDialogue}, {name: 'Options', callback: openSettingsMenu}, {name: 'Exit to menu', callback: returnBackToMenu},
	];
	...
	[ {name: 'Resume', callback: closeMenu}, {name: 'Restart Song', callback: restartSong},
#if debug {name: 'No Miss Mode', callback: toggleNoMiss},
		#{name: 'Change Character', callback: changeCharacter}, {name: 'Options', callback: openSettingsMenu}, {name: 'Exit to menu', callback: returnBackToMenu},
	];
	...
	[ {name: 'Resume', callback: closeMenu}, {name: 'Restart Song', callback: restartSong},
#if debug {name: 'No Miss Mode', callback: toggleNoMiss},
		#{name: 'Change Player', callback: returnToPlayerSelect}, {name: 'Options', callback: openSettingsMenu}, {name: 'Exit to menu', callback: returnBackToMenu},
	];
...
var scrollSpeed:Float = 50;
		...
		#(pauseMusic.volume < 0.75 ? pauseMusic.volume : null)
#+= 0.01 * elapsed
...
#(PlayStatePlaylist.isStoryMode ? returnToMenu : null)
#(() -> Void StoryMenuState())
#else
...
#(MathGameState.failedGame ? MathGameState.failedGame : null)
#= false
